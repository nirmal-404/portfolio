...
const skillsByCategory = {
  ...
  database: [
    ...
    { name: "Drizzle", icon: "https://orm.drizzle.team//favicon.ico" },
    { name: "Sequelize", icon: "https://www.svgrepo.com/show/374071/sequelize.svg" },
  ...
  devops: [
    ...
    { name: "Kubernetes", icon: "https://www.svgrepo.com/show/376331/kubernetes.svg" },
  ...
  tools: [
    ...
    { name: "BitBucket", icon: "https://wac-cdn.atlassian.com/assets/img/favicons/bitbucket/favicon-32x32.png" },
    { name: "GitTea", icon: "https://about.gitea.com/gitea.png" },
    { name: "Postman", icon: "https://www.vectorlogo.zone/logos/getpostman/getpostman-icon.svg" },
    { name: "API Dog", icon: "https://assets.apidog.com/static/logo/favicon.ico" },
...
const categories = [
  ...
  { id: "database", name: "Databases + ORMs" },
